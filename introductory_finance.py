...
if option == "stock screener":
    ...
    exportList.append("Stock": stock, "RS_rating": RS_rating, "50 Day MA": ma_50,)
    ...
    for i in stocklist.index :
        ...
        try:
            ...
            for x in smasUsed:
                sma = x
                smaString = "SMA_" + str(sma)
                df[smaString] = round(df.iloc[:,4].rolling(window = sma).mean(),2)
            ...
            if(cond_1 and cond_2 and cond_3 and cond_4 and cond_5 and cond_6 and cond_7 and cond_8):
                row = pd.Series([stock, RS_rating, moving_average_50, moving_average_150, moving_average_200, low_of_52week, high_of_52week], index = ["Stock", "RS_rating", "50 Day MA", "150 Day MA", "200 Day MA", "52 Week Low",  "52 week High"])
    ...
    newFile = os.path(filePath) + "/ScreenOutput.xlsx"
